  ...
  <div class='row'>
	...
	if($customers=='1'){
		...
		foreach($x as $customerID){
			mysql_query("UPDATE tbl_customer SET deleted = '1' WHERE customerID='$customerID'");
		}
		echo "
				<div class = 'alert alert-success'>	
				   <center>Items are successfully deleted. <a href='customer'>Back to Customers.</a></center>
				</div>
		";
		}else{
